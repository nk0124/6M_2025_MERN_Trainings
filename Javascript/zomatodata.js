...
let new_arr=data.map((el,index)=>{
    // console.log(el.info.name);
    // console.log(el.info.rating.rating_text);
    // console.log(el.info.image.url);
    return {name:el.info.name, rating:el.info.rating.rating_text, image:el.info.image.url}
})
console.log(new_arr);

let ratingarr=data.filter((el,index)=>{
    if(el.info.rating.rating_text>=3.5){
        // console.log(el.info.name)
        return el
    }
})
let new_rating=ratingarr.map((el,index)=>{
    return {name:el.info.name, rating:el.info.rating.rating_text}
})
