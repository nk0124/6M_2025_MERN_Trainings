...
for(let i=0;i<data.SECTION_SEARCH_RESULT.length;i++){
    console.log(data.SECTION_SEARCH_RESULT[i].info.name);
    console.log(data.SECTION_SEARCH_RESULT[i].info.ratingNew.ratings.DINING.rating);
    console.log(data.SECTION_SEARCH_RESULT[i].distance);
    console.log(data.SECTION_SEARCH_RESULT[1].info.costText.text)

}
// name
let search=data.SECTION_SEARCH_RESULT
for(let y of search){    // for of -> provide direct value
    console.log(y.info.name); 
}

for(let x of search){
    console.log(x.info.ratingNew.ratings.DINING.rating);
}


for(let z of search){
    console.log(z.distance)
}

for(let c of search){
    console.log(c.info.costText.text)
}